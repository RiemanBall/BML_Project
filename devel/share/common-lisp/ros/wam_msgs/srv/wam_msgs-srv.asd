...
(defsystem "wam_msgs-srv"
  ...
  :components ((:file "_package")
    ...
    (:file "LoggerInfo" :depends-on ("_package_LoggerInfo"))
    (:file "_package_LoggerInfo" :depends-on ("_package"))
    ...
    (:file "JointTrajectoryVelocityMove" :depends-on ("_package_JointTrajectoryVelocityMove"))
    (:file "_package_JointTrajectoryVelocityMove" :depends-on ("_package"))
    ...
    (:file "SpecialService" :depends-on ("_package_SpecialService"))
    (:file "_package_SpecialService" :depends-on ("_package"))
