...
int main(int argc, char **argv)
{
  ...
  float pos3[] ={-1.604, -0.749, -0.035,  2.025,  0.007,  0.294,  0.053};
  ...
  double startPoint[] = {-1.604, -0.749, -0.035,  2.025,  0.007,  0.294,  0.053};
  ...
  start_pose.orientation.y = 0.9998;
  start_pose.orientation.z = -0.0175;
  ...
  while(currLearning) //currEpisode
  {
    ...
    else if(actionSpace.compare("6") == 0)
    {
      curr_pose.position.x -=  0.1;
      curr_pose.position.z +=  0.008716;
      planAndMove = true;
    }
    else if(actionSpace.compare("7") == 0)
    {
      curr_pose.position.x -=  0.1;
      curr_pose.position.z += 0;
      planAndMove = true;
    }
    else if(actionSpace.compare("8") == 0)
    {
      curr_pose.position.x -=  0.1;
      curr_pose.position.z -=  0.008716;
      planAndMove = true;
