...
[segOrientEst, IMUReadEst] = configUpdate_OS(x_s1, x_j1 * jointAxis, frameNum);         % Predict next motion
r = residual_OS(IMUReadEst, output);                        % Compute the residual
J = jacob_OS_stage1(r, x_est, output, jointAxis);                       % Compute the Jacobian of the residual
