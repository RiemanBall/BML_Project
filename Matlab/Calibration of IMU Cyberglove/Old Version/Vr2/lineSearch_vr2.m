...
function alpha = lineSearch_vr2(x_est, x_pred, IMUOutputOrient, J0, r0, h, M, V, frameNum, type)
...
function [phi, dPhi, lemda] = parameters(x_est, x_pred, M, V, alpha, h, frameNum, IMUOutputOrient, lemdaFunh)
    ...
    r = residual_vr2(IMUOrient_est, IMUOutputOrient);                       
    J= jacob_vr2(r, x_est, fingerOrient_est, IMUOrient_est, IMUOutputOrient);
