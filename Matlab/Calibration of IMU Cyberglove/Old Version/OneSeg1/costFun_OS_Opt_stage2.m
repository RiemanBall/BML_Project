function [f, g, H] = costFun_OS_Opt_stage2( x_est, x_pred, output, frameNum, constVarNum, M, V, fixed_x_s1 )
...
[~, IMUReadEst] = configUpdate_OS(x_s1, x_j1, frameNum);         % Predict next motion
r = residual_OS(IMUReadEst, output);                        % Compute the residual
J = jacob_OS_stage2(r, x_est, output);                       % Compute the Jacobian of the residual
