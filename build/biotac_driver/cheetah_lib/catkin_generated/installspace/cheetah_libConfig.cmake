...
if("FALSE" STREQUAL "TRUE")
  set(cheetah_lib_SOURCE_PREFIX /home/robot/rieman_ws/src/biotac_driver/cheetah_lib)
  set(cheetah_lib_DEVEL_PREFIX /home/robot/rieman_ws/devel)
  ...
  set(cheetah_lib_INSTALL_PREFIX /home/robot/rieman_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'cheetah_lib' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Francisco Vina <fevb@kth.se>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'cheetah_lib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/rieman_ws/install/${idir}'.  Ask the maintainer 'Francisco Vina <fevb@kth.se>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${cheetah_lib_dep}_FOUND)
      find_package(${cheetah_lib_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${cheetah_lib_dep} REQUIRED ${depend_list})
  endif()
